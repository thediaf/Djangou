 ...
 */
final class Version20200315053240 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE history ADD token VARCHAR(255) NOT NULL, CHANGE is_memorised is_memorised TINYINT(1) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE history DROP token, CHANGE is_memorised is_memorised TINYINT(1) DEFAULT \'NULL\'');
